...
public class CollectAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collect_attendance);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);

        progressBar = findViewById(R.id.collect_attendance_progress_bar);
        ...
        recyclerView = findViewById(R.id.collect_attendance_recyclerView);
        searchText = findViewById(R.id.collect_attendance_search_text);
        selectDateText = findViewById(R.id.collect_attendance_date_text);
        goToHomePageBtn = findViewById(R.id.collect_attendance_go_to_home_page_btn);
        goToHomePage();
    ...
    private void attendanceReportDatePicker() {
        ...
        selectDateText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(CollectAttendance.this,
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot.exists()) {
                    ...
                    if (attendance != null && attendance.getStatus().equals("APPROVED")) {
                        adapter.notifyDataSetChanged();
                        attendanceList.add(attendance);
                        filteredAttendanceList.add(attendance);
                    }
                } else {
                    Toast.makeText(CollectAttendance.this, "Data Not Found", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            adapter.setOnItemClickListener(new AttendanceAdapter.OnItemClickListener() {
                ...
                public void onItemClick(int position) {
                    if (!filteredAttendanceList.isEmpty() && filteredAttendanceList.size() > position) {
                        if(filteredAttendanceList.get(position).getStatus().equals("APPROVED")) {
                            operComfirmDialogue(filteredAttendanceList.get(position).getTokenNo());
                        } else {
                            Toast.makeText(CollectAttendance.this, "Already COLLECTED!!", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(CollectAttendance.this, "Searched List Fail!!", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }else{
            Toast.makeText(CollectAttendance.this, "Role "+role, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void operComfirmDialogue(final String tokenNo) {
        ...
        builder.setMessage("Are you sure you want to COLLECT ?")
                .setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        reference.child(tokenNo).child("status").setValue("COLLECTED");
                        reference.child(tokenNo).child("collectedBy").setValue(username);
                        Toast.makeText(CollectAttendance.this, "Attendance COLLECTED Successfully!!", Toast.LENGTH_SHORT).show();
                        AttendanceRecycler();
                    }
                })
